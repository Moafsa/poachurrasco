...
<form action="{{ $action }}" method="POST" enctype="multipart/form-data" class="space-y-8">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 space-y-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <label for="establishment_id" class="block text-sm font-medium text-gray-700">Estabelecimento</label>
            ...
            <div>
                <label for="subcategory" class="block text-sm font-medium text-gray-700">Subcategoria</label>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div>
                <label for="compare_price" class="block text-sm font-medium text-gray-700">Preço de Comparação</label>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700">Dimensões (cm)</label>
                <div class="mt-2 grid grid-cols-3 gap-3">
                    <input type="number" step="0.01" name="dimensions[length]" placeholder="Comprimento" value="{{ $dimensions['length'] ?? '' }}"
                           class="rounded-xl border border-gray-300 focus:ring-2 focus:ring-churrasco-500 focus:border-churrasco-500">
                    <input type="number" step="0.01" name="dimensions[width]" placeholder="Largura" value="{{ $dimensions['width'] ?? '' }}"
                           class="rounded-xl border border-gray-300 focus:ring-2 focus:ring-churrasco-500 focus:border-churrasco-500">
                    <input type="number" step="0.01" name="dimensions[height]" placeholder="Altura" value="{{ $dimensions['height'] ?? '' }}"
                           class="rounded-xl border border-gray-300 focus:ring-2 focus:ring-churrasco-500 focus:border-churrasco-500">
                </div>
            </div>
            <div class="space-y-3">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <input type="number" id="low_stock_threshold" name="low_stock_threshold" value="{{ old('low_stock_threshold', $product->low_stock_threshold ?? 5) }}"
                           class="w-32 rounded-xl border border-gray-300 focus:ring-2 focus:ring-churrasco-500 focus:border-churrasco-500" placeholder="Estoque mínimo">
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <label class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-700">Controlar estoque</span>
            </label>
            <label class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-700">Permitir pedidos em falta</span>
            </label>
            <label class="inline-flex items-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <label class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-700">Este produto é um serviço</span>
            </label>
            <label class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-700">Produto digital</span>
            </label>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <label for="videos" class="block text-sm font-medium text-gray-700">URLs de Vídeo</label>
                <input type="text" id="videos" name="videos" value="{{ is_array(old('videos')) ? implode(' ', old('videos')) : $videosValue }}"
                       placeholder="cole URLs separadas por espaço"
                       class="mt-2 block w-full rounded-xl border border-gray-300 focus:ring-2 focus:ring-churrasco-500 focus:border-churrasco-500">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                ...
                <textarea id="ingredients" name="ingredients" rows="4" placeholder="Um ingrediente por linha"
            ...
            <div>
                <label for="nutritional_info" class="block text-sm font-medium text-gray-700">Informação Nutricional</label>
                <textarea id="nutritional_info" name="nutritional_info" rows="4" placeholder="Um item por linha"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                <label for="allergens" class="block text-sm font-medium text-gray-700">Alérgenos</label>
                <textarea id="allergens" name="allergens" rows="4" placeholder="Um alérgeno por linha"
            ...
            <div>
                <label for="storage_instructions" class="block text-sm font-medium text-gray-700">Instruções de Armazenamento</label>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div>
                <label for="expiry_date" class="block text-sm font-medium text-gray-700">Data de Validade</label>
                <input type="date" id="expiry_date" name="expiry_date" value="{{ old('expiry_date', optional($product->expiry_date ?? null)->format('Y-m-d')) }}"
                       class="mt-2 block w-full rounded-xl border border-gray-300 focus:ring-2 focus:ring-churrasco-500 focus:border-churrasco-500">
            </div>
            <div>
                <label for="seo_score" class="block text-sm font-medium text-gray-700">Pontuação SEO</label>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div>
                <label for="meta_title" class="block text-sm font-medium text-gray-700">Título Meta</label>
                <input type="text" id="meta_title" name="meta_title" value="{{ old('meta_title', $product->meta_title ?? '') }}"
                       class="mt-2 block w-full rounded-xl border border-gray-300 focus:ring-2 focus:ring-churrasco-500 focus:border-churrasco-500">
            </div>
            <div class="lg:col-span-2">
                <label for="meta_description" class="block text-sm font-medium text-gray-700">Descrição Meta</label>
            ...
            @if(!empty($product?->images))
                <div class="mt-4 grid grid-cols-2 md:grid-cols-4 gap-4">
                    @foreach($product->images as $image)
                        <img src="{{ Storage::disk('public')->url($image) }}" alt="Imagem do produto" class="w-full h-32 object-cover rounded-xl border border-gray-200">
                    @endforeach
                </div>
            @endif
        </div>
